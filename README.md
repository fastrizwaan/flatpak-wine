...
![](https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.1/winezgui-0.93.1.png)
...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.1/flatpak-winezgui_0.93.1_20230228.flatpak
  # Install
  flatpak --user install flatpak-winezgui_0.93.1_20230228.flatpak
  # Run
