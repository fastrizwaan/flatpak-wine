...
![](https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.6/winezgui-0.93.6.png)
...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.6/flatpak-winezgui_0.93.6_20230302.flatpak
  # Install
  flatpak --user install flatpak-winezgui_0.93.6_20230302.flatpak
  # Run
