...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.96.5/flatpak-winezgui_0.96.5_20230519.flatpak
  flatpak --user install flatpak-winezgui_0.96.5_20230519.flatpak
