...
![](https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.2/winezgui-0.93.2.png)
...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.2/flatpak-winezgui_0.93.2_20230228.flatpak
  # Install
  flatpak --user install flatpak-winezgui_0.93.2_20230228.flatpak
  # Run
