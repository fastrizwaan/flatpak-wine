...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.96.12g/flatpak-winezgui_0.96.8_20230521.flatpak
  flatpak --user install flatpak-winezgui_0.96.12g_20230521.flatpak
