...
![](https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.7/winezgui-0.93.7.png)
...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.7/flatpak-winezgui_0.93.7_20230302.flatpak
  # Install
  flatpak --user install flatpak-winezgui_0.93.7_20230302.flatpak
  # Run
