...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.96.6/flatpak-winezgui_0.96.6_20230519.flatpak
  flatpak --user install flatpak-winezgui_0.96.6_20230519.flatpak
