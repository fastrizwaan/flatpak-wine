...
- [x] Template support
  ...
  wget -c https://github.com/fastrizwaan/flatpak-wine/releases/download/0.93.4/flatpak-winezgui_ 0.93.4_20230301.flatpak
  # Install
  flatpak --user install flatpak-winezgui_ 0.93.4_20230301.flatpak
  # Run
